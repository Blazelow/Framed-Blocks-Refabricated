...
public final class ClientConfig
{
    ...
    public static final String TRANSLATION_SHOW_CAMO_CRAFTING_IN_JEI = translate(KEY_SHOW_CAMO_CRAFTING_IN_JEI);
    ...
    private static final FabricConfigSpec.BooleanValue SHOW_GHOST_BLOCKS_VALUE;
    private static final FabricConfigSpec.BooleanValue ALT_GHOST_RENDERER_VALUE;
    private static final FabricConfigSpec.IntValue GHOST_RENDER_OPACITY_VALUE;
    private static final FabricConfigSpec.BooleanValue FANCY_HITBOXES_VALUE;
    private static final FabricConfigSpec.BooleanValue DETAILED_CULLING_VALUE;
    private static final FabricConfigSpec.BooleanValue USE_DISCRETE_UV_STEPS_VALUE;
    private static final FabricConfigSpec.EnumValue<ConTexMode> CON_TEX_MODE_VALUE;
    private static final FabricConfigSpec.StringListValue CON_TEX_DISABLE_LIST_VALUE;
    private static final FabricConfigSpec.EnumValue<CamoMessageVerbosity> CAMO_MESSAGE_VERBOSITY_VALUE;
    private static final FabricConfigSpec.BooleanValue FORCE_AO_ON_GLOWING_BLOCKS_VALUE;
    private static final FabricConfigSpec.BooleanValue RENDER_ITEM_MODELS_WITH_CAMO_VALUE;
    private static final FabricConfigSpec.BooleanValue SHOW_ALL_RECIPE_PERMUTATIONS_IN_EMI_VALUE;
    private static final FabricConfigSpec.EnumValue<SolidFrameMode> SOLID_FRAME_MODE_VALUE;
    private static final FabricConfigSpec.BooleanValue SHOW_BUTTON_PLATE_OVERLAY_VALUE;
    private static final FabricConfigSpec.BooleanValue SHOW_SPECIAL_CUBE_OVERLAY_VALUE;
    private static final FabricConfigSpec.BooleanValue RENDER_CAMO_IN_JADE_VALUE;
    private static final FabricConfigSpec.BooleanValue SHOW_CAMO_CRAFTING_IN_JEI_VALUE;

    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> MAX_OVERLAY_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> STATE_LOCK_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> TOGGLE_WATERLOG_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> TOGGLE_Y_SLOPE_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> REINFORCEMENT_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> PRISM_OFFSET_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> SPLIT_LINE_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> ONE_WAY_WINDOW_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> FRAME_BACKGROUND_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> CAMO_ROTATION_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> TRAPDOOR_TEXTURE_ROTATION_MODE_VALUE;
    private static final FabricConfigSpec.EnumValue<OverlayDisplayMode> COPYCAT_STYLE_MODE_VALUE;

    public static void init()
    {
        SPEC.load();
        onConfigReloaded();
        // TODO (Step 8 - Cloth Config): Register GUI screen with ModMenu
    }

    static
    {
        FabricConfigSpec.Builder builder = new FabricConfigSpec.Builder("framedblocks-client.toml");
        ...
        SHOW_CAMO_CRAFTING_IN_JEI_VALUE = builder
                ...
                .translation(TRANSLATION_SHOW_CAMO_CRAFTING_IN_JEI)
                .worldRestart()
    ...
    {
        // Fabric: validate that the value is a non-empty string (mod presence checked at load time)
        return val instanceof String string && !string.isBlank();
    }
