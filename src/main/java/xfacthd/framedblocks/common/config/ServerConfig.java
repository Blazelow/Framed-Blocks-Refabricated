...
public final class ServerConfig
{
    ...
    private static final FabricConfigSpec.BooleanValue ALLOW_BLOCK_ENTITIES_VALUE;
    private static final FabricConfigSpec.BooleanValue ENABLE_INTANGIBLE_FEATURE_VALUE;
    private static final FabricConfigSpec.BooleanValue ONE_WAY_WINDOW_OWNABLE_VALUE;
    private static final FabricConfigSpec.BooleanValue CONSUME_CAMO_ITEM_VALUE;
    private static final FabricConfigSpec.IntValue GLOWSTONE_LIGHT_LEVEL_VALUE;
    private static final FabricConfigSpec.BooleanValue FIREPROOF_BLOCKS_VALUE;

    private static final FabricConfigSpec.IntValue POWERED_SAW_ENERGY_CAPACITY_VALUE;
    private static final FabricConfigSpec.IntValue POWERED_SAW_MAX_RECEIVE_VALUE;
    private static final FabricConfigSpec.IntValue POWERED_SAW_CONSUMPTION_VALUE;
    private static final FabricConfigSpec.IntValue POWERED_SAW_RECIPE_DURATION_VALUE;
    ...
    static
    {
        FabricConfigSpec.Builder builder = new FabricConfigSpec.Builder("framedblocks-server.toml");
