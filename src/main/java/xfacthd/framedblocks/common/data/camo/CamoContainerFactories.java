...
public final class CamoContainerFactories
{
    ...
    public static void registerCamoFactories()
    {
        ...
        // TODO (Step 4 - Capabilities): Replace with Fabric Transfer API fluid storage check
        // fluidRegistrar.registerApplicationPredicate(stack -> FluidStorage.ITEM.find(stack, ...) != null);
        // fluidRegistrar.registerRemovalPredicate(stack -> FluidStorage.ITEM.find(stack, ...) != null);
