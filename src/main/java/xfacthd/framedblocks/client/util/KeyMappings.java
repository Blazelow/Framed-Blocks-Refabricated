...
public final class KeyMappings
{
    ...
    public static final KeyMapping KEYMAPPING_UPDATE_CULLING = makeKeyMapping("update_cull", GLFW.GLFW_KEY_F9);
    public static final KeyMapping KEYMAPPING_WIPE_CACHE = makeKeyMapping("wipe_cache", -1);

    private static KeyMapping makeKeyMapping(String name, int key)
    {
    ...
    public static void onClientTick()
    {
        ...
        if (KEYMAPPING_UPDATE_CULLING.consumeClick())
        {
        ...
        if (KEYMAPPING_WIPE_CACHE.consumeClick())
        {
